(ns marketentry.store
  "SSoT for the PHL market-entry compliance actor, behind a `Store`
...
(defn demo-data
  ...
  []
  {:engagements
   {"eng-1" {:id "eng-1" :operator "Kita Systems PH" :portal "PhilGEPS"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-ph-entity? true :has-ph-entity? true
             :requires-sec? true :sec-verified? true
             :drafted? false :submitted? false
             :jurisdiction "PHL" :status :intake}
    "eng-2" {:id "eng-2" :operator "Atlantis LLC" :portal "PhilGEPS"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-ph-entity? true :has-ph-entity? true
             :requires-sec? true :sec-verified? true
    ...
    "eng-3" {:id "eng-3" :operator "Minami Systems" :portal "PhilGEPS"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             ...
             :drafted? false :submitted? false
             :jurisdiction "PHL" :status :intake}
    "eng-4" {:id "eng-4" :operator "Higashi Export" :portal "PhilGEPS"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-ph-entity? true :has-ph-entity? false
             :requires-sec? true :sec-verified? true
             :drafted? false :submitted? false
             :jurisdiction "PHL" :status :intake}
    "eng-5" {:id "eng-5" :operator "Nishi Logistics" :portal "PhilGEPS"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-ph-entity? true :has-ph-entity? true
             :requires-sec? true :sec-verified? false
             :drafted? false :submitted? false
             :jurisdiction "PHL" :status :intake}
    "eng-6" {:id "eng-6" :operator "Chuo Civic Tech" :portal "PhilGEPS"
...
(defn- engagement->tx [{:keys [id operator portal base-fee monthly-rate monitoring-months claimed-fee
                               requires-ph-entity? has-ph-entity?
                               requires-sec? sec-verified?
                               drafted? submitted?
  ...
  (cond-> {:engagement/id id}
    ...
    (some? requires-ph-entity?)  (assoc :engagement/requires-ph-entity? requires-ph-entity?)
    (some? has-ph-entity?)       (assoc :engagement/has-ph-entity? has-ph-entity?)
    (some? requires-sec?)    (assoc :engagement/requires-sec? requires-sec?)
    (some? sec-verified?)    (assoc :engagement/sec-verified? sec-verified?)
...
(def ^:private engagement-pull
  [:engagement/id :engagement/operator :engagement/portal :engagement/base-fee :engagement/monthly-rate
   ...
   :engagement/requires-ph-entity? :engagement/has-ph-entity?
   :engagement/requires-sec? :engagement/sec-verified?
...
(defn- pull->engagement [m]
  (when (:engagement/id m)
    {:id (:engagement/id m) :operator (:engagement/operator m) :portal (:engagement/portal m)
     ...
     :requires-ph-entity? (boolean (:engagement/requires-ph-entity? m))
     :has-ph-entity? (boolean (:engagement/has-ph-entity? m))
     :requires-sec? (boolean (:engagement/requires-sec? m))
     :sec-verified? (boolean (:engagement/sec-verified? m))
