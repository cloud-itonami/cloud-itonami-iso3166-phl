# cloud-itonami-iso3166-phl

Open ISO 3166 Blueprint for **PHL**: the Philippines.
...
tax registration, and local-content rules in the Philippines, so the operator
...
- **Not the government of the Philippines.** See
...
- **Not legal or tax advice.** Every regulatory claim must cite the
  official source and route final filings to Philippine-licensed counsel
...
(ISO 3166 `PHL`). Required capabilities:
