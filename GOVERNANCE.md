...
`cloud-itonami-iso3166-phl` is an OSS open-business blueprint. Governance covers both code and
the operator model.
...
Philippine-licensed counsel or a registered agent for whatever licensed
representation the law of the Philippines requires for public-procurement
filings.
